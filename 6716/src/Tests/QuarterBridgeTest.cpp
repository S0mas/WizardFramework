...
bool QuarterBridgeTest::test() const {
	...
	//4)
	bu3100_sleep(50);
	auto errorDetected = checkValues(CHANNEL_MASK, readValues(bu3416_GAIN_1, CHANNEL_MASK, 0.1), "L1301", 0.0, 0.050, 0.050);
	//5)
	...
	//6)
	bu3100_sleep(50);
	errorDetected |= checkValues(CHANNEL_MASK, readValues(bu3416_GAIN_1, CHANNEL_MASK, 0.1), "L1302", -1.225, 0.075, 0.075);
	//7)
