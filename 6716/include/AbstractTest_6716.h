...
public:
	...
	ViUInt16 checkValues(const ViUInt16 channelMask, const std::vector<ViReal64>& values, const std::string& limitName, const ViReal64 expected, const ViReal64 marginNeg, const ViReal64 marginPos, ViBoolean verbose = true, ViBoolean checkGains = true) const noexcept;
	...
	void closeAll();
public:
	Abstract6716Test(const QString&& name, const std::shared_ptr<Communication_6716>& connection, const bool summaryOn = false);
};
